...
$result = $conn->query("SELECT * FROM usuarios WHERE usuario_registered=0 ORDER BY usuario_dni DESC LIMIT $offset,$numPorPagina ");
...
while($row = $result->fetch_assoc()){
 ...
 <div class="container mt-4 p-4 bg-white">
     ...
     <div class="row text-center">
       <div class="col-4 ">
          <a class="btn btn-primary" href="leads.php">Turno 1</a>
       </div>
       <div class="col-4 ">
          <a class="btn btn-primary" href="leads.php">Turno 2</a>
       </div>
       <div class="col-4 ">
          <a class="btn btn-primary" href="leads.php">Turno 3</a>
       </div>
         <div class="col-md-12">
